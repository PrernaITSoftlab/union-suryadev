...
import { 
  ...
  CheckCircle2, Sparkles, Building2, Zap, ShieldAlert, Award, PhoneCall, ChevronRight, UserPlus, LogIn
} from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-12 pb-24 lg:pt-20 lg:pb-32 bg-gradient-to-b from-white via-amber-50/40 to-slate-50 border-b border-slate-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-100 border border-amber-300 text-amber-800 text-xs font-bold uppercase tracking-wider shadow-sm">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <Link
                  to="/join"
                  className="w-full sm:w-auto px-8 py-4 rounded-xl text-base font-extrabold bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 shadow-xl shadow-amber-500/25 transition-all flex items-center justify-center gap-2 transform hover:-translate-y-0.5"
                >
                ...
                <Link
                  to="/login"
                  className="w-full sm:w-auto px-8 py-4 rounded-xl text-base font-bold bg-white hover:bg-slate-100 border border-slate-300 text-slate-800 shadow-sm transition-all flex items-center justify-center gap-2"
                >
              ...
              {/* Highlights badge */}
              <div className="pt-6 grid grid-cols-3 gap-4 border-t border-slate-200 text-xs">
                <div>
                  <div className="text-xl font-extrabold text-slate-900">15,000+</div>
                  <div className="text-slate-500 font-semibold">Discom Members</div>
                </div>
                <div>
                  <div className="text-xl font-extrabold text-amber-700">9 Circles</div>
                  <div className="text-slate-500 font-semibold">MP West Zone</div>
                </div>
                <div>
                  <div className="text-xl font-extrabold text-sky-700">100%</div>
                  <div className="text-slate-500 font-semibold">Digital QR Join</div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-3xl p-1 bg-gradient-to-b from-amber-400/40 via-amber-200/50 to-slate-200/80 shadow-2xl">
                <div className="bg-white rounded-[22px] p-6 space-y-6 border border-slate-200">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-bold text-slate-900 text-sm">Discom HQ Notice</h3>
                        <p className="text-[11px] text-slate-500">Polo Ground, Indore</p>
                      </div>
                    </div>
                    <span className="px-2.5 py-1 rounded-full bg-red-100 text-red-800 border border-red-300 text-[10px] font-extrabold uppercase tracking-wider">
                      Active Union Notice
                    </span>
                  </div>

                  {/* Active Strike Banner Preview */}
                  <div className="p-4 rounded-2xl bg-red-50/80 border border-red-200 space-y-2">
                    <div className="flex items-center gap-2 text-xs font-extrabold text-red-700">
                      ...
                      <span>INDEFINITE STRIKE AGITATION</span>
                    </div>
                    <p className="text-xs text-slate-700 leading-snug">
                      Demand for Old Pension Scheme (OPS), regularization of contract linemen, and ₹20 Lakh accident relief.
                    </p>
                    <Link to="/events" className="text-[11px] text-amber-700 hover:underline flex items-center gap-1 font-bold pt-1">
                      <span>View Full Charter of Demands</span>
                  ...
                  <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200 flex items-center justify-between">
                    <div>
                      <span className="text-[10px] uppercase font-bold text-amber-800 tracking-wider block">Membership Registration</span>
                      <span className="text-xl font-extrabold text-slate-900">₹{settings?.registration_fee || 500} / Annual</span>
                    </div>
                    <Link
                      to="/join"
              ...
              {announcements.map(a => (
                <div 
                  ...
                  className={`p-5 rounded-2xl border transition-all ${
                    a.type === 'STRIKE' || a.priority === 'CRITICAL'
                ...
                >
                  <div className="flex items-center justify-between text-[11px] font-bold uppercase tracking-wider mb-3">
                    <span className={`px-2.5 py-0.5 rounded-full ${
                      a.type === 'STRIKE' ? 'bg-red-200 text-red-900' : 'bg-amber-100 text-amber-900'
                    }`}>
                      {a.type}
                    </span>
